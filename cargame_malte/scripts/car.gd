...
func _physics_process(delta): 
 ...
 if is_airborne: 
  ...
  var air_input = Vector3( 
   (Input.get_action_strength("Reverse") - Input.get_action_strength("Gas")) * air_control_pitch_strength * 
fade_multiplier, 
   (Input.get_action_strength("Left") - Input.get_action_strength("Right")) * air_control_yaw_strength * fade_multiplier, 
   (Input.get_action_strength("RollRight") - Input.get_action_strength("RollLeft")) * air_control_roll_strength * 
fade_multiplier 
  ) 
